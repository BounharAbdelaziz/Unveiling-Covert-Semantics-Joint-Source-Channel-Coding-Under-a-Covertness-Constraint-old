...
lambda_l2_regularization=0 #0.0005
# dataset='IID'
dataset='MNIST'
# dataset='CIFAR10'
...
list_target_epsilon_n_dict[512]="0.010" 
list_target_epsilon_n_dict[768]="0.010" 
list_target_epsilon_n_dict[1024]="0.0050" 
list_target_epsilon_n_dict[2048]="0.0050" 
list_target_epsilon_n_dict[4096]="0.0010" 
